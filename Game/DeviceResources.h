...
namespace DX {
    // Provides an interface for an application that owns DeviceResources to be notified of the
    // device being lost or created.
    ...
    public:
        static constexpr unsigned int kFlipPresent  = 0x1;
